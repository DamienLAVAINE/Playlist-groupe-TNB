const tracks = [
  { name: "Speedman", file: "audio/TNB-MAT 24 07 2026 Speedman.mp3", duration: "3:16" },
  { name: "Ice melting", file: "audio/TNB-MAT 24 07 2026 Ice melting.mp3", duration: "4:36" },
  { name: "Cours Forest", file: "audio/TNB-MAT 24 07 2026 Cours Forest.mp3", duration: "4:19" },
  { name: "Troquet blues", file: "audio/TNB-MAT 24 07 2026 Troquet blues.mp3", duration: "4:15" },
  { name: "Crazy remake song", file: "audio/TNB-MAT 24 07 2026 Crazy.mp3", duration: "5:01" },
  { name: "Truc et machin", file: "audio/TNB-MAT 24 07 2026 Trucs et machins.mp3", duration: "3:50" },
  { name: "Strange", file: "audio/TnB - Strange time (MAT + basse Dam).mp3", duration: "3:27" },
  { name: "Baby oh baby", file: "audio/TnB - Baby oh baby (MAT + basse Dam).mp3", duration: "4:09" },
  { name: "Ca balance", file: "audio/TnB - Ca balance (MAT + basse Dam).mp3", duration: "3:06" },
  { name: "Et si c'était demain", file: "audio/TnB - Et si c'était demain (MAT + basse Dam).mp3", duration: "4:09" },
  { name: "P'tit d'homme", file: "audio/TnB - Pti d'homme (MAT + basse Dam).mp3", duration: "4:47" },
  ...
  { name: "L'envers de l'endroit", file: "audio/TnB - L'envers de l'endroit (MAT + basse Dam).mp3", duration: "3:14" },
